...
//   - Auto-generated trainings (public/js/core/dates.js generateAutoTrainings) are
...
//   - Hardcoded home match 'ce1' (public/js/main.js): "Partido vs Santboi", Sat 2026-09-26.
//
...
// ---------------------------------------------------------------------------
export const seed = {
  // profiles: public/js/core/auth.js onAuthenticated (select *) + handleRegister upsert,
  // public/js/features/jugadoras.js applyPlantillaRows, perfil.js saveProfileEdits.
  ...
  // Covers use the small images in public/assets/img (p3/gipsy/etc. are 8-16 MB).
  gallery_data: [
    {
      id: 'current',
  ...
  // push_subscriptions: write-only from public/js/push.js upsert (profile_id, fcm_token,
